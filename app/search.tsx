  ...
  return (
    <View className="flex-1 bg-white">
      ...
      <View className="flex-row items-center gap-3 px-4" style={{ paddingTop: insets.top + 24 }}>
        <View className="flex-1 flex-row items-center gap-2 rounded-full border-[1.5px] border-[#111111] px-4 py-1">
          <Pressable hitSlop={12} onPress={() => router.back()}>
            <Iconify icon="mynaui:chevron-left" size={20} color="#111111" />
          </Pressable>
          <TextInput
            ref={inputRef}
            value={query}
